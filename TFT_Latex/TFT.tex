...
Maeda Gutiérrez (2019) realizó una comparativa entre varias arquitecturas CNN \cite{estudio1}

Huerta Mora et al. (2024) emplearon la arquitectura VGG16 con técnicas de fine-tuning \cite{estudio3}
