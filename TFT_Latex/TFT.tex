...
Tomate o tomatera (Solanum lycopersicum) es una planta herbácea de la familia Solanaceae cultivada en todo el mundo para el cultivo de su fruto, el tomate o jitomate, uno de los ingredientes más universales de ensaladas y salsas en el mundo entero.
...
(PRODUCCIÓN TOMATE) El tomate es la hortaliza más difundida en todo el mundo y la de mayor valor económico. Su demanda aumenta continuamente y con ella su cultivo, producción y comercio. El incremento anual de la producción en los últimos años se debe principalmente al aumento en el rendimiento y en menor proporción al aumento de la superficie cultivada.

La producción mundial de tomate, ascienden a más de 177 millones de toneladas; solamente China se produjo 56 millones de toneladas para el año 2016 según la FAO. Y desde hace varios años la tendencia siempre ha sido al alza.

Esta es la evolución de la producción mundial de tomate según los datos de la Organización de las Naciones Unidas para la Alimentación y la Agricultura (FAO). En 2022, el total mundial fue de 186 108 000 toneladas, y el país con mayor producción fue China, con 68 241 800 toneladas, el 36.67 del total.
