...
0: np.float64(0.8317317357565036), 
1: np.float64(0.9575078689131642), 
2: np.float64(0.7549359512426553), 
3: np.float64(0.8532420392674476), 
4: np.float64(0.815501064416936), 
5: np.float64(1.3451684224216414), 
6: np.float64(1.2862828006466858), 
7: np.float64(1.152295008912656), 
8: np.float64(1.0914367118661954), 
9: np.float64(0.7703996126773677), 
10: np.float64(2.338986883763003)
