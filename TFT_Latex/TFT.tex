...
\usepackage{setspace}
\setstretch{1.15} % interlineado 1.3
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.2]{./Images/Intro/Yellow-leaf-curl-virus-tomato.jpg}
