...
\begin{table}[ht] 
\centering
\caption{\headlinecolor{\underline{Top 10 países productores de tomates 2022.}} Fuente: \parencite{wikipedia2}}
...
\caption{\headlinecolor{\underline{Picadura de la araña roja de dos manchas en una planta de tomate \parencite{inspiredpencil}}}}
...
\begin{itemize}
    \item \textbf{Modelos}
    \begin{itemize}
        \item \texttt{modelo1}: red convolucional base para clasificación multiclase.
        \item \texttt{modelo2}: versión optimizada con aumento de datos.
    \end{itemize}
    \item \textbf{Datos}
    \begin{itemize}
        \item \texttt{train/}: imágenes de entrenamiento organizadas por clase.
        \item \texttt{valid/}: imágenes de validación organizadas por clase.
    \end{itemize}
    \item \textbf{Scripts}
    \begin{itemize}
        \item \texttt{preprocesamiento.py}: normalización y segmentación de hojas.
        \item \texttt{entrenamiento.py}: definición y entrenamiento del modelo.
        \item \texttt{evaluacion.py}: métricas y generación de informes.
    \end{itemize}
\end{itemize}
