...
\item Tizón tardío (Phytophthora infestans): Puede destruir por completo una plantación si no se controla a tiempo, especialmente en condiciones húmedas y templadas.
\item Tizón temprano (Alternaria solani): Produce defoliación progresiva, debilitando la planta y reduciendo el número y calidad de los frutos.
\item Fusariosis vascular (Fusarium oxysporum): Ataca el sistema vascular, provocando marchitez y muerte de plantas.
