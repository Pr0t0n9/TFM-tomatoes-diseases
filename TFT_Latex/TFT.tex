...
\section{Modelo \textit{EfficientNetB0} 2}\label{sec:sec5.4}

\section{Modelo \textit{EfficientNetB0} 3}\label{sec:sec5.5}


\section{Modelo \textit{NASNetMobile} 1}\label{sec:sec5.6}
...
\section{Modelo \textit{NASNetMobile} 2}\label{sec:sec5.7}
