...
Debido a los recursos disponibles ha sido necesario el uso de callbacks para el entrenamiento que permitieran guardar información
HistorySaver: Histórico métricas
ModelCheckpoint: Punto de guardado cada cierto número de epoch

En los modelos optimizados se han usado otros dos callbacks:
EarlyStopping: evita seguir entrenando innecesariamente cuando el modelo ya no progresa, y asegura quedarte con la mejor versión del modelo.
ReduceLROnPlateau: si el modelo llega a una especie de meseta, pueda seguir refinando con pasos más pequeños sin quedarse bloqueado.
